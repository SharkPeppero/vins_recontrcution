...
void FeatureTracker::readImage(const cv::Mat &_img, double _cur_time) {
  ...
  if (EQUALIZE) {
    ...
    img = _img;
#ifdef TimeCostDebug
  LOG(INFO) << "image equalize time cost: " << equalize_timer.toc() << "ms.";
#endif
...
#ifdef TimeCostDebug
    LOG(INFO) << "lk time cost: " << lk_timer.toc() << "ms.";
#endif
  }
